...
import { findProductsByCategory } from "@/database/queries";
...
export default async function ShopPage({ params: { categories, lang } }) {

    const category = decodeURIComponent(categories);
